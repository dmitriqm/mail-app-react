...
function App() {
  return (
    <>
      <header className="flex items-center border-b min-w-[33.5rem] border-x bg-slate-50 mx-1 mb-2 rounded-xl">
        <Logo />
        <SearchPanel />
        <AuthIcon />
      </header>

      <main className="flex flex-auto h-full overflow-hidden mx-1 bg-slate-50" >
        <Folders />
        <Mails />
      </main>
    </>
